	...
	<div class = "opbar">
	    <center>
	        <ul>
	            ...
	            <li><button name = "search" class = "button">搜索</button></li>
	        </ul>
	    </center>
	</div>
    <table class="mt">		<!-- 绘制表格 -->
		...
		<tbody>
			<?php
				...
				while($row = mysqli_fetch_row($res)){
					...
					echo "<a href='adm.php?act=deleteData&name=".$tablename."&id=".$row[$priNum]."#pos'><button class='delete-button'>删除</button></a></td>";
					echo "</tr>";
				}
			?>
		</tbody>
